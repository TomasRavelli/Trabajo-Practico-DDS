	...
	public InterfazConsultarTicket(Principal frame) {
			...
			public void actionPerformed(ActionEvent e) {
				if(table_1.getSelectedRow() != -1 && table_1.getSelectedRow() < ticketsEncontrados.size()) {
					...
					if (ticketSeleccionado!=null) {
						...
						JOptionPane.showMessageDialog(null, "Debe seleccionar un ticket para poder cerrarlo.");
					}
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				if(table_1.getSelectedRow() != -1 && table_1.getSelectedRow() < ticketsEncontrados.size()) {
					...
					if(ticketSeleccionado!=null) {
						...
						JOptionPane.showMessageDialog(null, "Debe seleccionar un ticket para poder verlo");
					}
				}
			}
		});
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(!comboBoxDiaApertura.getSelectedItem().toString().equals("DD") && !comboBoxMesApertura.getSelectedItem().toString().equals("MM") && !comboBoxAnioApertura.getSelectedItem().toString().equals("AAAA")) {
					...
					if(fechaApertura.isAfter(LocalDate.now())) {
				...
				if(!comboBoxDiaCambio.getSelectedItem().toString().equals("DD") && !comboBoxMesCambio.getSelectedItem().toString().equals("MM") && !comboBoxAnioCambio.getSelectedItem().toString().equals("AAAA")) {
					...
					if(fechaUltimoCambioEstado.isAfter(LocalDate.now())) {
						JOptionPane.showMessageDialog(null, "Fecha(s) no valida(s).");
					}
